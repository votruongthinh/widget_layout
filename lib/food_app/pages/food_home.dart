...
class _info_card_item extends StatelessWidget {
  const _info_card_item({super.key});
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Image.asset("assets/images/meat.webp", height: 70, width: 70),
                const SizedBox(height: 10),
                const Text("Meat"),
              ],
            ),
...
class _info_intro extends StatelessWidget {
  const _info_intro({super.key});
...
class _info_person extends StatelessWidget {
  const _info_person({super.key});
